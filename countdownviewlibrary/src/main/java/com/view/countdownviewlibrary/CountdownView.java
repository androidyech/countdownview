package com.view.countdownviewlibrary;
...
public class CountdownView extends View {
    ...
    private int viewBgBorderSize =0;
    private int viewBgColor =-1;
    private int viewBgBorderColor =-1;
    private int viewBgBorderRadius =0;
    private int viewTL_Radius = 0;
    private int viewTR_Radius = 0;
    private int viewBL_Radius = 0;
    private int viewBR_Radius = 0;
    ...
    public CountdownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        viewBgColor =  ta.getColor(R.styleable.CountdownView_viewBgColor,Color.parseColor("#ffffff"));
        viewBgBorderColor =  ta.getColor(R.styleable.CountdownView_viewBgBorderColor,Color.parseColor("#ffffff"));
        viewBgBorderSize =  ta.getDimensionPixelSize(R.styleable.CountdownView_viewBgBorderSize,0);
        viewBgBorderRadius =  ta.getDimensionPixelSize(R.styleable.CountdownView_viewBgBorderRadius,0);
        viewTL_Radius =  ta.getDimensionPixelSize(R.styleable.CountdownView_viewTL_Radius,0);
        viewTR_Radius =  ta.getDimensionPixelSize(R.styleable.CountdownView_viewTR_Radius,0);
        viewBL_Radius =  ta.getDimensionPixelSize(R.styleable.CountdownView_viewBL_Radius,0);
        viewBR_Radius =  ta.getDimensionPixelSize(R.styleable.CountdownView_viewBR_Radius,0);
    ...
    public void setViewBgBorderSize(int viewBgBorderSize) {
        this.viewBgBorderSize = viewBgBorderSize;
        setShape();
    }
    ...
    public void setViewBgBorderColor(int viewBgBorderColor) {
        this.viewBgBorderColor = viewBgBorderColor;
        setShape();
    }


    public void setViewBgBorderRadius(int viewBgBorderRadius) {
        this.viewBgBorderRadius = viewBgBorderRadius;
        setShape();
    }

    public int getViewTR_Radius() {
        return viewTR_Radius;
    }

    public void setViewTR_Radius(int viewTR_Radius) {
        this.viewTR_Radius = viewTR_Radius;
        setShape();
    }

    public void setViewBL_Radius(int viewBL_Radius) {
        this.viewBL_Radius = viewBL_Radius;
        setShape();
    }

    public void setViewBR_Radius(int viewBR_Radius) {
        this.viewBR_Radius = viewBR_Radius;
        setShape();
    }
    ...
    private void setShape(){
        ...
        //设置填充颜色
        gradientDrawable.setColor(viewBgColor);
        //设置描边
        gradientDrawable.setStroke(viewBgBorderSize, viewBgBorderColor);
        //设置弧度
        if(viewBgBorderRadius == 0&&(viewTR_Radius !=0|| viewTL_Radius !=0|| viewBL_Radius !=0|| viewBR_Radius !=0)){
            float radius_list[]={viewTL_Radius, viewTL_Radius, viewTR_Radius, viewTR_Radius, viewBL_Radius, viewBL_Radius, viewBR_Radius, viewBR_Radius};
            gradientDrawable.setCornerRadii(radius_list);
        }else {
            gradientDrawable.setCornerRadius(viewBgBorderRadius);
        }
